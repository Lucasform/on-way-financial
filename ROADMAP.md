...
> **PIVOT 2026-09-14:** app agora é 100% focado em finanças de obra (fornecedores, materiais,
> cotações, previsão). Módulos genéricos (viagem/carro/presente/educação/custom), visão geral
> de finanças doméstica, extrato bancário/import, alertas e recorrências foram removidos.
> Todo o conteúdo abaixo desta linha é histórico anterior ao pivot; pode estar desatualizado.
